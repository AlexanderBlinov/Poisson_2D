...
int main(int argc, char* argv[]) {
    ...
    double *U = (double *)calloc((size_t)(r1 * Q1 + 1) * r2 * r3 * r4 * Q4, sizeof(double));
    double *preBack = (double *)calloc((size_t)(r1 * Q1 + 1) * r2 * r4 * Q4, sizeof(double));
    double *preLeft = (double *)calloc((size_t)(r1 * Q1 + 1) * r3 * r4 * Q4, sizeof(double));
    double *preBackLeft = (double *)calloc((size_t) (r1 * Q1 + 1) * r4 * Q4, sizeof(double));
...
//                    printf("%d (%d, %d) receives upLeft from %d\n", rank, igl1, igl4, upLeft);
                    MPI_Recv(preBackLeft + (igl1 * r1 + 1) * r4 * Q4 + igl4 * r4, 1, prek_t,
                             upLeft, tag * igl1 + igl4, grid_comm, &status);
//                    printf("%d (%d, %d) received upLeft from %d\n", rank, igl1, igl4, upLeft);
                    upLeftRecved = true;
                }
                if (next) {
//                    printf("%d (%d, %d) Ireceives upLeft from %d\n", rank, igl1, igl4, upLeft);
                    MPI_Irecv(preBackLeft + (igl1_n * r1 + 1) * r4 * Q4 + igl4_n * r4, 1, prek_t,
                              upLeft, tag * igl1_n + igl4_n, grid_comm, &request_upLeft);
...
//                    printf("%d (%d, %d) receives up from %d\n", rank, igl1, igl4, up);
                    MPI_Recv(preBack + (igl1 * r1 + 1) * r2 * r4 * Q4 + igl4 * r4, r1, preik_t,
                             up, tag * igl1 + igl4, grid_comm, &status);
                    upRecved = true;
//                    printf("%d (%d, %d) received up from %d\n", rank, igl1, igl4, up);
                }
                if (next) {
//                    printf("%d (%d, %d) Ireceives up from %d\n", rank, igl1, igl4, up);
                    MPI_Irecv(preBack + (igl1_n * r1 + 1) * r2 * r4 * Q4 + igl4_n * r4, r1, preik_t,
                              up, tag * igl1_n + igl4_n, grid_comm, &request_up);
...
//                    printf("%d (%d, %d) receives left from %d\n", rank, igl1, igl4, left);
                    MPI_Recv(preLeft + (igl1 * r1 + 1) * r3 * r4 * Q4 + igl4 * r4, r1, prejk_t,
                             left, tag * igl1 + igl4, grid_comm, &status);
                    leftRecved = true;
//                    printf("%d (%d, %d) received left from %d\n", rank, igl1, igl4, left);
                }
                if (next) {
//                    printf("%d (%d, %d) Ireceives left from %d\n", rank, igl1, igl4, left);
                    MPI_Irecv(preLeft + (igl1_n * r1 + 1) * r3 * r4 * Q4 + igl4_n * r4, r1, prejk_t,
                              left, tag * igl1_n + igl4_n, grid_comm, &request_left);
...
//                                    printf("1\n");
//                                }
                                uim = preLeft[(i1 * r3 + i3) * r4 * Q4 + i4];
                            } else {
//                                int q = ((i1 * r2 + i2 - 1) * r3 + i3) * r4 * Q4 + i4;
//                                if (q >= (r1 * Q1 + 1) * r2 * r3 * r4 * Q4) {
//                                    printf("2\n");
//                                }
                                uim = U[((i1 * r2 + i2 - 1) * r3 + i3) * r4 * Q4 + i4];
                            }
...
//                                    printf("3\n");
//                                }
                                uip = preBack[((i1 - 1) * r2 + i2) * r4 * Q4 + i4 - 1];
                            } else {
//                                int q = (((i1 - 1) * r2 + i2) * r3 + i3 - 1) * r4 * Q4 + i4 - 1;
//                                if (q >= (r1 * Q1 + 1) * r2 * r3 * r4 * Q4) {
//                                    printf("4\n");
//                                }
                                uip = U[(((i1 - 1) * r2 + i2) * r3 + i3 - 1) * r4 * Q4 + i4 - 1];
                            }
...
//                                    printf("5\n");
//                                }
                                ujm = preBack[(i1 * r2 + i2) * r4 * Q4 + i4];
                            } else {
//                                int q = ((i1 * r2 + i2) * r3 + i3 - 1) * r4 * Q4 + i4;
//                                if (q >= (r1 * Q1 + 1) * r2 * r3 * r4 * Q4) {
//                                    printf("6\n");
//                                }
                                ujm = U[((i1 * r2 + i2) * r3 + i3 - 1) * r4 * Q4 + i4];
                            }
...
//                                    printf("7\n");
//                                }
                                ujp = preLeft[((i1 - 1) * r3 + i3) * r4 * Q4 + i4 - 1];
                            } else {
//                                int q = (((i1 - 1) * r2 + i2 - 1) * r3 + i3) * r4 * Q4 + i4 - 1;
//                                if (q >= (r1 * Q1 + 1) * r2 * r3 * r4 * Q4) {
//                                    printf("8\n");
//                                }
                                ujp = U[(((i1 - 1) * r2 + i2 - 1) * r3 + i3) * r4 * Q4 + i4 - 1];
                            }
...
//                                    printf("9\n");
//                                }
                                ukm = U[((i1 * r2 + i2) * r3 + i3) * r4 * Q4 + i4 - 1];
                            }
...
//                                        printf("10\n");
//                                    }
                                    ukp = preBackLeft[(i1 - 1) * r4 * Q4 + i4];
                                } else {
//                                    int q = ((i1 - 1) * r3 + i3 - 1) * r4 * Q4 + i4;
//                                    if (q >= (r1 * Q1 + 1) * r3 * r4 * Q4) {
//                                        printf("11\n");
//                                    }
                                    ukp = preLeft[((i1 - 1) * r3 + i3 - 1) * r4 * Q4 + i4];
                                }
                            } else {
                                if (i3 == 0) {
...
//                                        printf("12\n");
//                                    }
                                    ukp = preBack[((i1 - 1) * r2 + i2  - 1) * r4 * Q4 + i4];
                                } else {
//                                    int q = (((i1 - 1) * r2 + i2 - 1) * r3 + i3 - 1) * r4 * Q4 + i4;
//                                    if (q >= (r1 * Q1 + 1) * r2 * r3 * r4 * Q4) {
//                                        printf("13\n");
//                                    }
                                    ukp = U[(((i1 - 1) * r2 + i2 - 1) * r3 + i3 - 1) * r4 * Q4 + i4];
                                }
                            }
...
//                                        printf("14\n");
//                                    }
                                    u = preBackLeft[(i1 - 1) * r4 * Q4 + i4 - 1];
                                } else {
//                                    int q = ((i1 - 1) * r3 + i3 - 1) * r4 * Q4 + i4 - 1;
//                                    if (q >= (r1 * Q1 + 1) * r3 * r4 * Q4) {
//                                        printf("15\n");
//                                    }
                                    u = preLeft[((i1 - 1) * r3 + i3 - 1) * r4 * Q4 + i4 - 1];
                                }
                            } else {
                                if (i3 == 0) {
...
//                                        printf("16\n");
//                                    }
                                    u = preBack[((i1 - 1) * r2 + i2  - 1) * r4 * Q4 + i4 - 1];
                                } else {
//                                    int q = (((i1 - 1) * r2 + i2 - 1) * r3 + i3 - 1) * r4 * Q4 + i4 - 1;
//                                    if (q >= (r1 * Q1 + 1) * r2 * r3 * r4 * Q4) {
//                                        printf("17\n");
//                                    }
                                    u = U[(((i1 - 1) * r2 + i2 - 1) * r3 + i3 - 1) * r4 * Q4 + i4 - 1];
                                }
                            }
...
//                printf("%d (%d, %d) Isends downRight to %d \n", rank, igl1, igl4, downRight);
                MPI_Isend(U + (((igl1 * r1 + 2) * r2) * r3 - 1) * r4 * Q4 + igl4 * r4, 1, uk_t,
...
//                printf("%d (%d, %d) Isends down to %d \n", rank, igl1, igl4, down);
                MPI_Isend(U + (((igl1 * r1 + 1) * r2 + 1) * r3 - 1) * r4 * Q4 + igl4 * r4, r1, uik_t,
...
//                printf("%d (%d, %d) Isends right to %d \n", rank, igl1, igl4, right);
                MPI_Isend(U + ((igl1 * r1 + 2) * r2 - 1) * r3 * r4 * Q4 + igl4 * r4, r1, ujk_t,
...
//                printf("%d (%d, %d) waited left from %d\n", rank, igl1, igl4, left);
    ...
    if (rank == 0) {
                    ...
                    for (int i = 0; i < r2; ++i) {
                        for (int j = 0; j < r3; ++j) {
                            for (int k = 0; k < r4 * Q4; ++k) {
                                R[((r2 * n + i) * r3 * Q3 + r3 * m + j) * r4 * Q4 + k]
                                        = U[((rit * r2 + i) * r3 + j) * r4 * Q4 + k];
                            }
                        }
                    }
                    continue;
        ...
        MPI_Send(U + rit * r2 * r3 * r4 * Q4, r2 * r3 * r4 * Q4, MPI_DOUBLE, 0, 10005000, grid_comm);
    }
